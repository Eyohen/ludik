...
const caseStudies = [
  ...
  {
    id: 'manifold-revamp',
    title: 'Ogbainbiri Manifold Revamp',
    location: 'Niger Delta, Nigeria',
    client: 'Agip Oando',
    scope: 'Brownfield revamp works for existing production infrastructure, including dismantling, engineering redesign, fabrication, and reinstatement of the manifold system.',
    outcome: 'Restored full production capacity to the manifold system with enhanced safety features, delivered within the agreed schedule and budget with zero Lost Time Incidents.',
    tags: ['Brownfield', 'Fabrication', 'Production', 'Revamp'],
    image: civilImg,
    imageAlt: 'Nigerian engineers conducting inspection works at an oil production facility',
  },
  {
    id: 'crude-storage',
    title: 'Crude Oil Storage System — Amukpe',
    location: 'Delta State, Nigeria',
    client: 'Amukpe',
    scope: '100,000 BPD crude oil storage system project including tank construction, bundwall and piping works, structural steelwork, and associated civil engineering.',
